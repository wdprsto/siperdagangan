...
<body>
	...
	<div class="mb-4">
		...
		<h5 class="text-center"><?php echo 'Kasir '.$kasir->ksr_nama.' Tanggal ' . get_formatted_date_wo_day($tanggal)?></h5>
	</div>
				...
				<?php foreach ($barangs as $barang) : ?>
					...
					?>
						...
						<tr class="align-top text-info">
							<td colspan='3' class='text-center font-weight-bold'>Jumlah Kategori <?php echo $barang->kat_nama;?></td>
