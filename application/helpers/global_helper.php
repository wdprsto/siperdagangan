...
if ( ! function_exists('update_settings'))
{
    function update_settings($key, $new_content)
    {
        ...
        $CI->db->where('key', $key)
            ->update('ci_settings', array('content' => $new_content));
    }
}
...
if ( ! function_exists('get_admin_image'))
{
    function get_admin_image()
    {
        ...
        return base_url('assets/uploads/users/default.png');
    }
}
...
if ( ! function_exists('get_admin_name')) {
    function get_admin_name() {
        ...
        return $data->adm_nama;
    }
}

if ( ! function_exists('get_kasir_name'))
{
    function get_kasir_name()
    {
        $data = user_data();

        return $data->ksr_nama;
    }
}
...
if ( ! function_exists('get_formatted_date_wo_day'))
{
    function get_formatted_date_wo_day($source_date)
    {
        $d = strtotime($source_date);
...
{
    function get_month_name($source_date)
    {
        ...
        $month_name = $month_names[$source_date];
