      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
            <li class="ftco-animate"><a href="#products"><span class="icon-twitter"></span></a></li>
            <li class="ftco-animate"><a href="#products"><span class="icon-facebook"></span></a></li>
            <li class="ftco-animate"><a href="#products"><span class="icon-instagram"></span></a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        ...
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              ...
              <li><span class="icon icon-phone"></span><span class="text"><?php echo get_settings('store_phone_number'); ?></span></li>
              <li><span class="icon icon-envelope"></span><span class="text"><?php echo get_settings('store_email'); ?></span></li>
            </ul>
          </div>
        </div>
      </div>
...
<script>
  ...
  $('.add-cart').click(function(e) {
    ...
    if(maxQuantity==0){
      toastr.info('Semua stok yang tersedia sudah dimasukkan ke keranjang');
      return;
    }else if(qty>maxQuantity){
      toastr.info('Stok yang tersedia tidak dapat memenuhi pesanan');
      return;
    }
    ...
    $.ajax({
      ...
      success: function(res) {
        if (res.code == 200) {
          ...
          toastr.info('Item ditambahkan ke dalam keranjang');
          refresh();
