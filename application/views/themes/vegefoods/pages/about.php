    ...
    <div class="row">
      ...
      <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
        ...
        <div class="pb-md-5">
          ...
          <p><a href="<?php echo base_url().'#products'; ?>" class="btn btn-primary">Belanja sekarang!</a></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-5 pb-3">
      <div class="col-md-7 heading-section ftco-animate text-center">
        ...
        <p>Di <i>Bittersweet by Najwa</i>, kami percaya bahwa para pelanggan adalah raja. Maka dari itu, kami mendengarkan suara kalian.</p>
      </div>
    </div>
